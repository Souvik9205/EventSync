...
function EventDetailPage() {
  ...
  const handleReviewSubmit = async (rating: number) => {
    ...
    try {
      const response = await fetch(`${BACKEND_URL}/event/review`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
        body: JSON.stringify({ eventId, review: rating }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
      ...
      <div>
        <div className="relative min-h-[60vh] md:min-h-[45vh] lg:h-[60vh] overflow-hidden">
                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <div className="mt-6 md:mt-8 space-y-4 md:space-y-6">
                    {[
                      ...
                      {
                        icon: Users,
                        text: `${event.attendees} registered attendees`,
                      },
                    ].map((item, index) => (
                      <div
                        key={index}
